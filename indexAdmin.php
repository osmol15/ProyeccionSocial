...
<body id="app" class="app off-canvas">
	...
	<div class="main-container clearfix">
		...
		<aside class="nav-wrap" id="site-nav" data-perfect-scrollbar>
			<div class="nav-head">
				<!-- site logo -->
                                <a href="indexAdmin.php" class="site-logo text-uppercase">
				...
				<ul class="list-unstyled clearfix nav-list mb15">
					<li>
						...
						<ul class="inner-drop list-unstyled">
                                                    <li><a href="forms.elements.dan.html">Listar</a></li>
							<li><a href="forms.elements.dan.html">Crear</a></li>
							<li><a href="forms.elements.dan.html">Editar</a></li>
							<li><a href="forms.elements.dan.html">Eliminar</a></li>
						</ul>
					</li>
                                         <li>
						<a href="javascript:;">
						...
						<ul class="inner-drop list-unstyled">
                                                    	<li><a href="forms.elements.dan.html">Buscar por Estudiante</a></li>
                                                        <li><a href="forms.elements.dan.html">Buscar por Lugar</a></li>
                                                        <li><a href="forms.elements.dan.html">Buscar por Tutor</a></li>
                                                        <li><a href="forms.elements.dan.html">Buscar por Nombre</a></li>
                                                        <li><a href="forms.elements.dan.html">Listar</a></li>
						</ul>
					</li>
                                         <li>
						...
						<ul class="inner-drop list-unstyled">
                                                    	<li><a href="AgregarPeticion.php"  target="frameprincipal">Cargar Peticion</a></li>
                                                        <li><a href="forms.elements.dan.html">Buscar Nombre</a></li>
                                                        <li><a href="forms.elements.dan.html">Buscar Lugar</a></li>
                                                        <li><a href="forms.elements.dan.html">Editar</a></li>
                                                        <li><a href="forms.elements.dan.html">Eliminar</a></li>
						</ul>
					</li>
						...
						<ul class="inner-drop list-unstyled">
							<li><a href="forms.elements.dan.html">Estudiantes</a>
                                                        <li><a href="forms.elements.dan.html">Tutores</a></li>
                                                        <li><a href="forms.elements.dan.html">Coordinadores</a></li>
                                                        <li><a href="forms.elements.dan.html">Editar</a></li>
						...
						<ul class="inner-drop list-unstyled">
							<li><a href="forms.elements.dan.html">Ver</a>
                                                        <li><a href="forms.elements.dan.html">Cargar</a></li>
						</ul>
                                        </li>
                                         <li>
						<a href="index.html">
